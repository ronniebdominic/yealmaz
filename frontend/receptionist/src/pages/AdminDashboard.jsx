      ...
      <div className="content">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="stats-grid stagger-in tooltip-below" style={{ marginBottom: 24 }}>
            ...
            <div className="stats-grid stagger-in" style={{ marginBottom: 16 }}>
            ...
            <div className="stats-grid stagger-in" style={{ marginBottom: 8 }}>
